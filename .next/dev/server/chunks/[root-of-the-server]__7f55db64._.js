...
"[project]/app/lib/dbConnect.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function dbConnect() {
    ...
    if (!cached.promise) {
        ...
        cached.promise = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connect(MONGO_URI, opts).then((mongoose)=>{
            return mongoose;
        });
    }
...
"[project]/app/types.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/models/UserProblemData.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/types.ts [app-route] (ecmascript)");
;
;
const UserProblemDataSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Schema"]({
    userId: {
    ...
    status: {
        type: String,
        enum: Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProblemStatus"]),
        default: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProblemStatus"].Unsolved
    },
    isStarred: {
        type: Boolean,
        default: false
...
UserProblemDataSchema.index({
    userId: 1,
    problemId: 1
}, {
    unique: true
});
const __TURBOPACK__default__export__ = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.UserProblemData || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model('UserProblemData', UserProblemDataSchema);
}),
"[project]/app/data/assignments.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const problemsData = [
    // Group 1: Learn the basics
    {
        ...
        difficulty: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Difficulty"].Easy,
        category: 'Function',
    ...
    },
    {
        ...
        difficulty: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Difficulty"].Medium,
        category: 'Array',
        group: 'Step 2: Array Manipulation',
    ...
    },
    {
        ...
        difficulty: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Difficulty"].Hard,
        category: 'Algorithm',
        group: 'Step 4: Algorithms',
...
"[project]/app/api/problems/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$dbConnect$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/dbConnect.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$models$2f$UserProblemData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/models/UserProblemData.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$assignments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/data/assignments.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/types.ts [app-route] (ecmascript)");
...
async function GET(req) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$dbConnect$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authMiddleware"])(req);
    if (!user) {
        const staticProblems = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$assignments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["problemsData"].map((p)=>({
                ...p,
                status: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProblemStatus"].Unsolved,
                isStarred: false,
                notes: ''
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(staticProblems);
    }
    try {
        const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$models$2f$UserProblemData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            userId: user.id
        });
        const userDataMap = new Map(userData.map((item)=>[
                item.problemId,
                item
            ]));
        const mergedProblems = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$assignments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["problemsData"].map((p)=>{
            const userProgress = userDataMap.get(p.id);
            return {
                ...p,
                status: userProgress ? userProgress.status : __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProblemStatus"].Unsolved,
                isStarred: userProgress ? userProgress.isStarred : false,
                notes: userProgress ? userProgress.notes : ''
            };
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(mergedProblems);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7f55db64._.js.map