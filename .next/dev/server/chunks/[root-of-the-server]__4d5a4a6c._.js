...
async function dbConnect() {
    ...
    if (!cached.promise) {
        ...
        cached.promise = mongoose.connect(MONGO_URI, opts).then((mongoose1)=>{
            return mongoose1;
        });
    }
...
const __TURBOPACK__default__export__ = mongoose.models.UserProblemData || mongoose.model('UserProblemData', UserProblemDataSchema);
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d5a4a6c._.js.map